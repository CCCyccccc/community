...
//        loginTicketMapper.insertLoginTicket(loginTicket);
    ...
    public int updateHeader(int userId, String hearderUrl){
//        return userMapper.updateHeader(userId,hearderUrl);
        int rows = userMapper.updateHeader(userId,hearderUrl);
        clearCache(userId);
        return rows;
    }
